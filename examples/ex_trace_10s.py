...
def main(session):
    ...
    for node_id in nodes:
        ...
        for worker_id in workers:
            ...
            if worker[u'type'] == u'router':
                ...
                traces = yield session.call(u'crossbarfabriccenter.remote.tracing.get_router_traces', node_id, worker_id)
                ...
                for trace_id in traces:
                    trace = yield session.call(u'crossbarfabriccenter.remote.tracing.get_router_trace', node_id, worker_id, trace_id)
                    ...
                    if stop_running and trace[u'status'] == u'running':
                        ...
                        # stop the trace
                        stopped = yield session.call(u'crossbarfabriccenter.remote.tracing.stop_router_trace', node_id, worker_id, trace_id)

                # start a new trace ..
                trace_id = u'trace-001'
                trace_options = {}
                trace = yield session.call(u'crossbarfabriccenter.remote.tracing.start_router_trace', node_id, worker_id, trace_id, trace_options=trace_options)
    ...
    for node_id, worker_id, trace_id in started_traces:
        trace_data = yield session.call(u'crossbarfabriccenter.remote.tracing.get_router_trace_data', node_id, worker_id, trace_id, 0)
        stopped = yield session.call(u'crossbarfabriccenter.remote.tracing.stop_router_trace', node_id, worker_id, trace_id)
