...
* [Nodes](#nodes)
   * [cfc.remote.node.get_status](#cfcremotenodeget_status)
   * [cfc.remote.node.shutdown](#cfcremotenodeshutdown)
   * [cfc.remote.node.get_workers](#cfcremotenodeget_workers)
   * [cfc.remote.node.get_worker](#cfcremotenodeget_worker)
   * [cfc.remote.node.start_worker](#cfcremotenodestart_worker)
   * [cfc.remote.node.stop_worker](#cfcremotenodestop_worker)
* [Workers](#workers)
    * [cfc.remote.worker.shutdown](#cfcremoteworkershutdown)
    * [cfc.remote.worker.get_status](#cfcremoteworkerget_status)
    * [cfc.remote.worker.get_pythonpath](#cfcremoteworkerget_pythonpath)
    * [cfc.remote.worker.add_pythonpath](#cfcremoteworkeradd_pythonpath)
    * [cfc.remote.worker.get_worker_log](#cfcremoteworkerget_worker_log)
    * [cfc.remote.worker.get_cpu_affinity](#cfcremoteworkerget_cpu_affinity)
    * [cfc.remote.worker.set_cpu_affinity](#cfcremoteworkerset_cpu_affinity)
    * [cfc.remote.worker.get_profilers](#cfcremoteworkerget_profilers)
    * [cfc.remote.worker.start_profiler](#cfcremoteworkerstart_profiler)
    * [cfc.remote.worker.get_profile](#cfcremoteworkerget_profile)
* [Routers](#routers)
    * [Router Realms](#routerrealms)
        * [cfc.remote.router.get_router_realms](#cfcremoterouterget_router_realms)
        * [cfc.remote.router.get_router_realm](#cfcremoterouterget_router_realm)
        * [cfc.remote.router.start_router_realm](#cfcremoterouterstart_router_realm)
        * [cfc.remote.router.stop_router_realm](#cfcremoterouterstop_router_realm)
    * [Realm Roles](#realmroles)
        * [cfc.remote.router.get_realm_roles](#cfcremoterouterget_realm_roles)
        * [cfc.remote.router.get_realm_role](#cfcremoterouterget_realm_role)
        * [cfc.remote.router.start_realm_role](#cfcremoterouterstart_realm_role)
        * [cfc.remote.router.stop_realm_role](#cfcremoterouterstop_realm_role)
    * [Router Transports](#routertransports)
        * [cfc.remote.router.get_router_transports](#cfcremoterouterget_router_transports)
        * [cfc.remote.router.get_router_transport](#cfcremoterouterget_router_transport)
        * [cfc.remote.router.start_router_transport](#cfcremoterouterstart_router_transport)
        * [cfc.remote.router.stop_router_transport](#cfcremoterouterstop_router_transport)
    * [Transport Paths](#transportpaths)
        * [cfc.remote.router.get_transport_paths](#cfcremoterouterget_transport_paths)
        * [cfc.remote.router.get_transport_path](#cfcremoterouterget_transport_path)
        * [cfc.remote.router.start_transport_path](#cfcremoterouterstart_transport_path)
        * [cfc.remote.router.stop_transport_path](#cfcremoterouterstop_transport_path)
    * [Router Components](#routercomponents)
        * [cfc.remote.router.get_router_components](#cfcremoterouterget_router_components)
        * [cfc.remote.router.get_router_component](#cfcremoterouterget_router_component)
        * [cfc.remote.router.start_router_component](#cfcremoterouterstart_router_component)
        * [cfc.remote.router.stop_router_component](#cfcremoterouterstop_router_component)
* [Containers*](#containers)
    * [cfc.remote.container.get_container_components](#cfcremotecontainerget_container_components)
    * [cfc.remote.container.get_container_component](#cfcremotecontainerget_container_component)
    * [cfc.remote.container.start_container_component](#cfcremotecontainerstart_container_component)
    * [cfc.remote.container.stop_container_component](#cfcremotecontainerstop_container_component)
* [Proxies](#proxies)
    * [cfc.remote.proxy.get_proxy_transports](#cfcremoteproxyget_proxy_transports)
    * [cfc.remote.proxy.get_proxy_transport](#cfcremoteproxyget_proxy_transport)
    * [cfc.remote.proxy.start_proxy_transport](#cfcremoteproxystart_proxy_transport)
    * [cfc.remote.proxy.stop_proxy_transport](#cfcremoteproxystop_proxy_transport)
* [Tracing](#tracing)
    * [cfc.remote.tracing.get_router_traces](#cfcremotetracingget_router_traces)
    * [cfc.remote.tracing.get_router_trace](#cfcremotetracingget_router_trace)
    * [cfc.remote.tracing.start_router_trace](#cfcremotetracingstart_router_trace)
    * [cfc.remote.tracing.stop_router_trace](#cfcremotetracingstop_router_trace)
    * [cfc.remote.tracing.get_router_trace_data](#cfcremotetracingget_router_trace_data)
* [Docker](#docker)
    * [cfc.remote.docker.get_docker_status](#cfcremotedockerget_docker_status)
    * [cfc.remote.docker.get_docker_containers](#cfcremotedockerget_docker_containers)
    * [cfc.remote.docker.get_docker_container](#cfcremotedockerget_docker_container)
    * [cfc.remote.docker.start_docker_container](#cfcremotedockerstart_docker_container)
    * [cfc.remote.docker.stop_docker_container](#cfcremotedockerstop_docker_container)
    * [cfc.remote.docker.get_docker_images](#cfcremotedockerget_docker_images)
    * [cfc.remote.docker.get_docker_image](#cfcremotedockerget_docker_image)
    * [cfc.remote.docker.update_docker_image](#cfcremotedockerupdate_docker_image)
    * [cfc.remote.docker.remove_docker_image](#cfcremotedockerremove_docker_image)
